...
#         self.assertEqual(200, connectivity)
        connectivity = requests.head('http://cerfpi3.calvin.edu')
        self.assertEqual(200, connectivity)
        connectivity = requests.head('http://cerfpi4.calvin.edu')
        self.assertEqual(200, connectivity)
        connectivity = requests.head('http://cerfpi5.calvin.edu')
        self.assertEqual(200, connectivity)
