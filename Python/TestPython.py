...
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(SENSOR_INFO[0], second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(first, second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(first, second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(first, second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(first, second, "globalVars.py incorrectly newPeakTimes.txt")
#        self.assertEqual(first, second, "globalVars.py incorrectly newPeakTimes.txt")
