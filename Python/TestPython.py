...
#         self.assertEqual(200, response.stats)
        connect = httplib.HTTPConnection("cerfpi3.calvin.edu/pages/index.php")
        connect.request("HEAD","/")
        response = connect.getresponse()
        self.assertEqual(200, response.stats)
        connect = httplib.HTTPConnection("cerfpi4.calvin.edu/pages/index.php")
        connect.request("HEAD","/")
        response = connect.getresponse()
        self.assertEqual(200, response.stats)
        connect = httplib.HTTPConnection("cerfpi5.calvin.edu/pages/index.php")
        connect.request("HEAD","/")
        response = connect.getresponse()
        self.assertEqual(200, response.stats)
