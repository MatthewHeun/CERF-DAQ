	...
	<div class="container-fluid">
		...
		<?php
			if (isset($_SESSION['userHASH'])) {
				$loginform = '<ul class="nav navbar-nav navbar-right">'
						   . '<li>'
						   . '<form class="navbar-form navbar-right" action="/pages/Elements/logout.inc.php" method="post">'
						   . '<button type="submit" class="btn btn-default mx1" name="logout-submit">Logout</button>'
						   . '</form>'
						   . '</li>'
						   . '</ul>';
			} else {
				$loginform = '<ul class="nav navbar-nav navbar-right">'
						   . '<li>'
						   . '<form class="navbar-form navbar-right" action="/pages/Elements/login.inc.php" method="post">'
						   . '<input type="text" class="form-control mx1" name="mailuid" placeholder="Username/Email...">'
						   . '<input type="password" class="form-control mx1" name="pwd" placeholder="Password...">'
						   . '<button type="submit" class="btn btn-default mx1" name="login-submit">Login</button>'
						   . '</form>'
						   . '</li>'
						   . '</ul>';
			}
