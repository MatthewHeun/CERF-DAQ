    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Pi <?php echo $Pi_Number ?>: <?php echo $SENSOR1 ?></a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				...
				<a href="sensor1.php?Day=<?php echo $prev ?>"><h3 style=" margin: 0px; margin-right: 10px; padding: 0px; float: left;"><</h3></a> 
				<a href="sensor1.php?Day=<?php echo $next ?>"><h3 style=" margin: 0px; margin-right: 10px; padding: 0px; float: left;"> ></h3></a>
