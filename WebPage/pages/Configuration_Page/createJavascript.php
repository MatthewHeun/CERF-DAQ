...
for ($i = 0; $i < $NUM_SENSORS; $i++){
		...
		fwrite($javaFile, '$("#sensorType');
			...
			$fileString .= 'if (sensorType == \'Occupancy\'){' . "\n";
				...
				$fileString .= 'document.getElementById("pinNum' . ($i+1) . '").style.display = "block";' . "\n";
				$fileString .= 'document.getElementById("MQTT' . ($i+1) . '").style.display = "none";' . "\n";
			$fileString .= '} else if (sensorType == \'Current\'){' . "\n";
				...
				$fileString .= 'document.getElementById("pinNum' . ($i+1) . '").style.display = "block";' . "\n";
				$fileString .= 'document.getElementById("MQTT' . ($i+1) . '").style.display = "none";' . "\n";
			$fileString .= '} else if (sensorType == \'MQTT\'){' . "\n";
				$fileString .= 'document.getElementById("voltage' . ($i+1) . '").style.display = "none";' . "\n";
				$fileString .= 'document.getElementById("i2cAddress' . ($i+1) . '").style.display = "none";' . "\n";
				$fileString .= 'document.getElementById("pinNum' . ($i+1) . '").style.display = "none";' . "\n";
				$fileString .= 'document.getElementById("MQTT' . ($i+1) . '").style.display = "block";' . "\n";
			$fileString .= '} else {' . "\n";
				$fileString .= 'document.getElementById("i2cAddress' . ($i+1) . '").style.display = "block";' . "\n";
				$fileString .= 'document.getElementById("voltage' . ($i+1) . '").style.display = "none";' . "\n";
				$fileString .= 'document.getElementById("pinNum' . ($i+1) . '").style.display = "block";' . "\n";
